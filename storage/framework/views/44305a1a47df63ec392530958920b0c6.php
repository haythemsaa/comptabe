<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" x-data x-bind:class="$store.app.darkMode ? 'dark' : ''">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo e($title ?? config('app.name')); ?> - ComptaBE</title>
...
<?php /**PATH C:\laragon\www\compta\resources\views/layouts/app.blade.php ENDPATH**/ ?>