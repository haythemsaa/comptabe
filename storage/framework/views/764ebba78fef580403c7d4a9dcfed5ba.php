...
<div class="relative" x-data="{
    ...
    search: '',
    selected: null,
    selectedValue: <?php echo e(json_encode($selectedValue)); ?>,
    options: [],
    filteredOptions: [],
    highlightedIndex: 0,

    init() {
        this.options = JSON.parse(document.getElementById('<?php echo e($componentId); ?>_data').textContent);
        if (this.selectedValue) {
            this.selected = this.options.find(o => o.<?php echo e($valueKey); ?> == this.selectedValue);
            if (this.selected) {
                this.search = this.selected.<?php echo e($displayKey); ?>;
            }
        }
    ...
    filter() {
        if (this.search.length === 0) {
            ...
            this.filteredOptions = this.options.filter(o => {
                const name = (o.<?php echo e($displayKey); ?> || '').toLowerCase();
    ...
    select(option) {
        ...
        this.selectedValue = option.<?php echo e($valueKey); ?>;
        this.search = option.<?php echo e($displayKey); ?>;
        this.open = false;
        this.$dispatch('change', { value: option.<?php echo e($valueKey); ?>, item: option });
    },
...
}" @click.away="open = false" <?php echo e($attributes); ?>>

    <!-- Data store -->
    <script type="application/json" id="<?php echo e($componentId); ?>_data"><?php echo json_encode($options, 15, 512) ?></script>
    ...
    <!-- Hidden input -->
    <input type="hidden" name="<?php echo e($name); ?>" :value="selectedValue" <?php echo e($required ? 'required' : ''); ?>>
    ...
    <div class="relative group">
        ...
        >
            ...
            <div class="flex-1 min-w-0">
                <div class="font-medium text-secondary-900 dark:text-white truncate" x-text="selected?.<?php echo e($displayKey); ?>"></div>
...
unset($__errorArgs, $__bag); ?>"
    ...
    >
        ...
        <div class="max-h-64 overflow-y-auto overscroll-contain">
            ...
            <template x-for="(option, index) in filteredOptions" :key="option.<?php echo e($valueKey); ?>">
                <div
                    @click="select(option)"
                    @mouseenter="highlightedIndex = index"
                    :class="{
                        'bg-primary-50 dark:bg-primary-900/30': highlightedIndex === index,
                        'bg-success-50 dark:bg-success-900/20': selectedValue == option.<?php echo e($valueKey); ?> && highlightedIndex !== index
                    }"
                ...
                >
                    ...
                    <template x-if="option.initials">
                        <div
                            ...
                            :class="selectedValue == option.<?php echo e($valueKey); ?>
                    ...
                    <!-- Content -->
                    <div class="flex-1 min-w-0">
                        <div class="font-medium text-secondary-900 dark:text-white truncate" x-text="option.<?php echo e($displayKey); ?>"></div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <svg
                            x-show="selectedValue == option.<?php echo e($valueKey); ?>"
...
<?php /**PATH C:\laragon\www\compta\resources\views/components/searchable-select.blade.php ENDPATH**/ ?>