...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Nouvelle facture <?php $__env->endSlot(); ?>

    <script>
        window.invoiceForm = function() {
            return {
                partnerId: '<?php echo e(old('partner_id', '')); ?>',
                partnerPeppolCapable: false,
                lines: [],
                lineIdCounter: 0,
                vatRates: <?php echo json_encode($vatRatesData, 15, 512) ?>,
                defaultVatRate: <?php echo e($companyDefaultVatRate); ?>,
                invoiceDate: '<?php echo e(old('invoice_date', date('Y-m-d'))); ?>',
                dueDate: '<?php echo e(old('due_date', date('Y-m-d', strtotime('+15 days')))); ?>',
                products: <?php echo json_encode($productsData, 15, 512) ?>,
                productSearch: '',
                productDropdownOpen: null,

                // Currency management
                currency: '<?php echo e(old('currency', $companyCurrency)); ?>',
                currenciesConfig: <?php echo json_encode(config('currencies.available'), 15, 512) ?>,
                currencyConfig: null,
                ...
                init() {
                    ...
                    <?php if(old('lines')): ?>
                        const oldLines = <?php echo json_encode(old('lines'), 15, 512) ?>;
                ...
                updateCurrencyFormat() {
                    this.currencyConfig = this.currenciesConfig[this.currency] || this.currenciesConfig['<?php echo e($companyCurrency); ?>'];
                },
    ...
    <?php $__env->startSection('breadcrumb'); ?>
        <a href="<?php echo e(route('dashboard')); ?>" class="text-secondary-500 hover:text-secondary-700">Accueil</a>
        <svg class="w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        </svg>
        <a href="<?php echo e(route('invoices.index')); ?>" class="text-secondary-500 hover:text-secondary-700">Factures</a>
        <svg class="w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        </svg>
    ...
    <form
        method="POST"
        action="<?php echo e(route('invoices.store')); ?>"
        x-data="{
            ...window.invoiceForm(),
    ...
    >
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e(route('invoices.index')); ?>" class="btn btn-secondary">Annuler</a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.searchable-select','data' => ['name' => 'partner_id','label' => 'Client','placeholder' => 'Rechercher un client...','options' => $partnersData,'required' => true,'displayKey' => 'name','valueKey' => 'id','xOn:change' => '
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'partner_id','label' => 'Client','placeholder' => 'Rechercher un client...','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($partnersData),'required' => true,'display-key' => 'name','value-key' => 'id','x-on:change' => '
                                        partnerId = $event.detail.value;
                                        partnerPeppolCapable = $event.detail.item?.peppol || false;
                                    ']); ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    x-model="invoiceDate"
                                    required
                                    class="form-input transition-all focus:ring-2 focus:ring-primary-500 <?php $__errorArgs = ['invoice_date'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    class="form-input <?php $__errorArgs = ['currency'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    required
                                >
                                    <?php $__currentLoopData = config('currencies.available'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $curr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($code); ?>" <?php echo e(old('currency', $companyCurrency) === $code ? 'selected' : ''); ?>>
                                            <?php echo e($curr['symbol']); ?> <?php echo e($code); ?> - <?php echo e($curr['name']); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <p class="form-helper">La devise par défaut est <?php echo e($companyCurrency); ?>, mais vous pouvez facturer dans n'importe quelle devise</p>
                    ...
                    <div class="card-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <?php if($products->count() > 0): ?>
                                <a href="<?php echo e(route('products.index')); ?>" class="text-xs text-primary-600 hover:text-primary-700 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                                    </svg>
                                    <?php echo e($products->count()); ?> produits
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('products.create')); ?>" class="text-xs text-primary-600 hover:text-primary-700 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="relative">
                                            ...
                                            >
                                                ...
                                                <div class="px-4 py-2 bg-secondary-50 dark:bg-secondary-900 border-t border-secondary-200 dark:border-secondary-700">
                                                    <a href="<?php echo e(route('products.create')); ?>" class="text-sm text-primary-600 hover:text-primary-700 flex items-center gap-1">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                                        </svg>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            >
                                                ...
                                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($account->id); ?>"><?php echo e($account->account_number); ?> - <?php echo e($account->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div class="pt-4 border-t border-secondary-200 dark:border-secondary-700">
                            ...
                            <input
                                ...
                                value="<?php echo e($structuredCommunication); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\compta\resources\views/invoices/create.blade.php ENDPATH**/ ?>