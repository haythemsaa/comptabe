...
@section('title', 'Nouveau modèle email')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">
                ...
                <span class="text-muted">/</span> Nouveau
            </h4>
        </div>
    </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       name="slug" value="{{ old('slug') }}" required placeholder="invoice-created">
                                @error('slug')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Catégorie</label>
                                <input type="text" class="form-control @error('category') is-invalid @enderror"
                                       name="category" value="{{ old('category') }}" list="categories" placeholder="Facturation">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control @error('subject') is-invalid @enderror"
                                       ...
                                       placeholder="Votre facture {invoice_number}">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <textarea class="form-control @error('body') is-invalid @enderror"
                                  name="body" rows="15" required>{{ old('body') }}</textarea>
                        @error('body')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <small class="text-muted">Utilisez les variables entre accolades: {company_name}, {client_name}, etc.</small>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-device-floppy me-1"></i> Créer
                            </button>
