<x-app-layout>
    ...
    @section('breadcrumb')
        ...
        <a href="{{ route('purchases.index') }}" class="text-secondary-500 hover:text-primary-500 dark:text-secondary-400 dark:hover:text-primary-400">Factures d'achat</a>
        <svg class="w-4 h-4 text-secondary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
        </svg>
    ...
    >
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('purchases.index') }}" class="btn btn-secondary">Annuler</a>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    class="form-input @error('invoice_number') form-input-error @enderror"
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                >
                                                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-secondary-400">{{ $companyCurrency }}</span>
                                            </div>
                                        </div>
