...
<x-app-layout>
    <x-slot name="title">Nouvelle facture recurrente</x-slot>
    ...
    <form
        method="POST"
        action="{{ route('recurring-invoices.store') }}"
    ...
    >
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-secondary-900 dark:text-white">Nouvelle facture recurrente</h1>
                <p class="text-secondary-600 dark:text-secondary-400">Automatisez la generation de factures</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('recurring-invoices.index') }}" class="btn btn-secondary">Annuler</a>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input
                                    ...
                                    placeholder="Ex: Abonnement mensuel, Maintenance trimestrielle..."
                                >
                                @error('name')
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('reference_prefix') }}"
                                    class="form-input"
                                    placeholder="Ex: ABO-"
                                >
                                <p class="form-helper">Ajoute au numero de facture</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="form-input"
                                >
                                <p class="form-helper">Ex: 2 = tous les 2 mois</p>
                            </div>
                            ...
                            <div x-show="frequency !== 'weekly'">
                                ...
                                <input
                                    ...
                                    class="form-input"
                                >
                                <p class="form-helper">1-28 (evite le 29-31 pour les mois courts)</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="form-input"
                                >
                                <p class="form-helper">Laissez vide pour une duree illimitee</p>
                            </div>
                                ...
                                <div class="p-4 bg-secondary-50 dark:bg-secondary-800/50 rounded-xl space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            class="form-input"
                                            placeholder="Ex: Abonnement {mois} {annee}"
                                        >
                                        <p class="form-helper">Variables: {mois}, {annee}, {date}</p>
                                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea
                            ...
                            rows="3"
                            class="form-input"
                            placeholder="Notes qui apparaitront sur les factures generees..."
                        >{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-4">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="auto_send" value="1" class="form-checkbox">
                            <span class="text-secondary-700 dark:text-secondary-300">Envoyer automatiquement par email</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="auto_send_peppol" value="1" class="form-checkbox">
                            <span class="text-secondary-700 dark:text-secondary-300">Envoyer via Peppol (si disponible)</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="include_structured_communication" value="1" checked class="form-checkbox">
                ...
                <div class="card bg-info-50 dark:bg-info-900/20 border-info-200 dark:border-info-800">
                    <div class="card-body">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h3 class="font-medium text-info-900 dark:text-info-100">Generation automatique</h3>
                                <p class="mt-1 text-sm text-info-700 dark:text-info-300">
                                    Les factures seront generees automatiquement selon la frequence choisie. Vous pouvez aussi les generer manuellement.
                                </p>
                            </div>
                        </div>
                    </div>
