    ...
    <div class="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div class="flex items-center gap-2">
            ...
            <div x-data="dropdown()" class="relative">
                ...
                >
                    <a href="{{ route('invoices.create') }}" class="dropdown-item flex items-center gap-3">
                        <svg class="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        Facture de vente
                    </a>
                    <a href="{{ route('purchases.create') }}" class="dropdown-item flex items-center gap-3">
                    ...
                    <a href="{{ route('partners.create') }}" class="dropdown-item flex items-center gap-3">
                    ...
                    <a href="{{ route('bank.import') }}" class="dropdown-item flex items-center gap-3">
            ...
            <div x-data="dropdown()" class="relative">
                ...
                >
                    <div class="px-4 py-3 border-b border-secondary-100 dark:border-dark-100">
                        <div class="font-medium text-secondary-900 dark:text-white">{{ auth()->user()->full_name }}</div>
                        <div class="text-sm text-secondary-500 dark:text-secondary-400">{{ auth()->user()->email }}</div>
                    </div>
                    <a href="{{ route('settings.index') }}" class="dropdown-item">Mon profil</a>
                    <a href="{{ route('tenant.select') }}" class="dropdown-item">Changer d'entreprise</a>
                    <div class="border-t border-secondary-100 dark:border-dark-100 my-1"></div>
